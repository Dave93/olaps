...
import {items} from "../../ProductsListPowerBI_2023_01.json"; //Возможно нужно будет переделать и удалить
...
Bun.write("./ProductsListPowerBI_2023_01.json", JSON.stringify({
  items,}));
// logger.info(text);
